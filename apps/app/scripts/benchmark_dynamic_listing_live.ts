...
function visualStrategy(item: BenchmarkCase): DynamicDesignStrategy {
  return {
    ...
    concept: {
      ...
      recommendedDesignMode: { mode: "HYBRID", confidence: 0.9, rationale: "benchmark fixture" },
      modeSignals: { typographyStrength: 0.8, humanActionStrength: 0.8, mascotPotential: 0.1, standaloneIllustrationStrength: 0.6 },
    },
    composition: { primaryFocus: "hybrid", hierarchy: [], textTreatment: "integrated", illustrationRelationship: "demonstrates the behavior", negativeSpaceStrategy: "controlled", silhouette: "strong", balance: "intentional", visibleTextRequired: true, maxPrimarySubjects: 1 },
    ...
    designModeDecision: { mode: "HYBRID", confidence: 0.9, rationale: "benchmark fixture" },
