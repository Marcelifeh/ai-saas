...
const SalesFeedbackSchema = z.object({
    ...
    visualBatchMetrics: z.record(z.string(), z.unknown()).optional(),
    visualStrategyMetrics: z.record(z.string(), z.unknown()).optional(),
    visualReleaseGate: z.record(z.string(), z.unknown()).optional(),
