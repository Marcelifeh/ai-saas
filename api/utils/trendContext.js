/**
 * Dynamic Trend Engine Context Builder
 * Injects current temporal context and randomized market angles to force LLM novelty.
 */
...
function getDynamicContext() {
    ...
    const upcoming = UPCOMING_HOLIDAYS_BY_MONTH[month];
